...
ripte <- read.csv("C://Users//Agustin//Documents//sivys_App_R//bd//RIPTE.csv", sep = ";", fileEncoding = "UTF-8", stringsAsFactors = FALSE)
smvm <- read.csv("C://Users//Agustin//Documents//sivys_App_R//bd//SMVM.csv", sep = ";", fileEncoding = "UTF-8", stringsAsFactors = FALSE)
